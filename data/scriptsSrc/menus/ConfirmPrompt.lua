...
function ConfirmPrompt:layout()
  ...
  if content ~= nil then
    bg:setSize(gamelua.screenWidth * 0.7, _G.math.min(gamelua.screenHeight * 0.8, _G.math.max(gamelua.screenHeight * 0.1, content:getHeight() * 3 + title:getHeight() + close.h)))
  else
    bg:setSize(_G.math.min(gamelua.screenWidth * 0.7, title:getWidth()), _G.math.min(gamelua.screenHeight * 0.8, _G.math.max(0, title:getHeight() + close.h * 0.5)))
  end
